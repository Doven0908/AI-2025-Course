...
from .conmcts import CON_MCTS_Tree,con_mcts
...
def parse_args(argv: list[str] | None = None):
    ...
    # serve_vllm parameters
    parser.add_argument("--n_sampling", default=3, type=int)
    parser.add_argument("--debug",type=str2bool,default=True)
    parser.add_argument("--use_api",type=str2bool, default=True)
    parser.add_argument("--num_of_models",type=int,default=2)
    parser.add_argument("--dtype", default="bf16", type=str)

    # aggregation parameters
    parser.add_argument("--output_strategy",type=str,choices=["follow_max",],default="follow_max")
    ...
    parser.add_argument("--explore_constant", type=float, default=1)
    
    parser.add_argument("--recheck_action",type=str2bool, default=False)
...
def main(llm, tokenizer, data_name, args):
    ...
    for i,example in enumerate(tqdm(examples,total=len(examples),disable=False)):
        ...
        tree_list.append(CON_MCTS_Tree(i,question,gt_ans,gt_cot,args))
                ...
                for fut,(idx,tree) in futures.items():
                    if args.debug:
                        ...
                        if all(r is None for r in final_tree_list):
                            visualize_tree(result.root,args)
